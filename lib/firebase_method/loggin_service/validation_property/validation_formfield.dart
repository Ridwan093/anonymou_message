import 'package:anonymouse_messages/firebase_method/loggin_service/validation_property/validator_service.dart';
...
class Validationform extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      onChanged: (value) {
        validationService.changeFirstName(value, islodin, context);
      },
    );
  }
}
